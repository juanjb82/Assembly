...
_start:
	;; Performs a series of very basic addition operations to
	;; demonstrate basic program format
	...
	;; ----
	;; Double-word example: dResult = dVar1 + dVar2
	mov 	eax, dword [dVar1]
	add 	eax, dword [dVar2]
	mov 	dword [dResult], eax

	;; ----
	;; Quad-word example: qResult = qVar1 + qVar2
	mov 	rax, qword [qVar1]
	add 	rax, qword [qVar2]
